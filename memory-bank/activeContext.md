...
`feat/step-sw-update-ux` — UX обновления SW: BUILD ✅

## Current Mode

BUILD ✅ — реализация завершена, verify пройден
...
- Текущая задача: `step-sw-update-ux` — BUILD ✅; баннер «Доступно обновление» + `registerType: 'prompt'`
